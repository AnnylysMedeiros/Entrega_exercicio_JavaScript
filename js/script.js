// Observando o código HTML escrito, percebemos que há sempre um padrão com os nomes, quantidades de itens e marcações que separam cada um dos trechos. Pronto! Resolvido.
...
for (var i = 1; i < cidade.length; i += 2) {
    console.log('Cidade: ' + cidade[i]);
}
...
var destinos = texto.split(/[#]/);

for (var i = 2; i < destinos.length; i += 3) {
    var temp2 = destinos[i].split('<br>')[1].split(';');
    console.log('Pontos turisticos:' + temp2);
    if (i > 2) break;
}
